package id.stockbit.ext.context
...
fun Context.canAuthenticate(): Boolean {
...
val Fragment.isNetworkAvailable: Boolean
    get() {
        return context?.isNetworkAvailable.orDefault()
    }
...
inline val Context.isNetworkAvailable: Boolean
    get() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            return manager?.activeNetworkInfo?.isConnected.orDefault()
        }
        return false
    }
